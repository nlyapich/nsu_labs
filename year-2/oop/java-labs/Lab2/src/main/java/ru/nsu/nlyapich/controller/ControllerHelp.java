...
public class ControllerHelp implements KeyListener, Session {
    private ModelHelp model;
    private boolean switchStatus;
    public ControllerHelp(ModelHelp help){
        model = help;
        switchStatus = false;
    }
    ...
    public boolean isSwitchStatus() {
        System.out.println("In controllerHelp switch status is " + (switchStatus ? "true" : "false"));
        return switchStatus;
    }
