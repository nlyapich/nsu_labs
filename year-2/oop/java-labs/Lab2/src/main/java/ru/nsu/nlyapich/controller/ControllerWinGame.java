...
public class ControllerWinGame implements KeyListener, Session {

    private ModelWinGame model;
    private boolean switchStatus;
    public ControllerWinGame(ModelWinGame winGame){
        model = winGame;
        switchStatus = false;
    }
    ...
    public boolean isSwitchStatus() {
        System.out.println("In controllerWinGame switch status is " + (switchStatus ? "true" : "false"));
        return switchStatus;
    }
